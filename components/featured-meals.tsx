            ...
            <Card key={id} className="overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <CardContent className="p-4">
                ...
                <div className="flex justify-between gap-2 items-center">
                    ...
                    {viewMore && <div className="flex gap-3 pt-4">
                                  <button type="submit" className="flex-1 px-2 py-1 text-xs rounded-md bg-orange-500 hover:bg-orange-600 text-white">
                                    Delete
                                  </button>
                                  <button
                                    type="button"
                    ...
                    <div>
                        <MoreVertical onClick={()=>setViewMore(()=>true)} className=""></MoreVertical>
                    </div>
                </div>
              </CardContent>
            </Card>
